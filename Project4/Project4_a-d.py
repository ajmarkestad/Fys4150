...
plt.title("Mean Absolute Maginetization of the Isingmodel PDF as a function cycles, with temperature 1 and ordered intitalization")
plt.xlabel('Number of cycles')
...
plt.title("Mean Energy of the Isingmodel PDF as a function cycles, with temperature 2.4 and random intitalization")
